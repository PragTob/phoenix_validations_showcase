defmodule ValidationShowcase.AccountsTest do
  use ValidationShowcase.DataCase

  alias ValidationShowcase.Accounts

  describe "users" do
    alias ValidationShowcase.Accounts.User

    @valid_attrs %{email: "some email", password_digest: "some password_digest"}
